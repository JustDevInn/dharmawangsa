  ...
  <nav className='text-primary lg:hidden'>
    ...
    top-0 right-0 max-w-xs h-screen z-20'>
      ...
      font-thin uppercase  tracking-widest text-3xl'>
        ...
        <li>
          <Link onClick={() => openMenu(!openMenu)} to='/about'>About</Link>
        </li>
        <li>
          <Link onClick={() => openMenu(!openMenu)} to='/donate'>Donate</Link>
        </li>
        <li>
          <Link onClick={() => openMenu(!openMenu)} to='/contact'>Contact</Link>
        </li>
      </ul>
    </motion.div>
  </nav>
